        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="text-danger">
              <i class="fa fa-mobile"></i>&nbsp;<?php echo ($userInfo["phone"]); ?> <span class="badge">积分：<?php echo ($userInfo["point"]); ?></span>
    ...
    <i class="fa fa-mail-reply"></i>
          ...
          <div class="panel-body">
            <div class="list-group">
              ...
              <?php if(is_array($pointList)): $i = 0; $__LIST__ = $pointList;if( count($__LIST__)==0 ) : echo "暂无积分记录" ;else: foreach($__LIST__ as $key=>$point): $mod = ($i % 2 );++$i;?><div href="#" class="list-group-item"> 
                    <h4 class="text-success">
                      <i class="fa fa-long-arrow-up"></i>
                      <span><?php echo ($point["point"]); ?><span>

                      <a href="<?php echo U('Point/detail');?>?id=<?php echo ($point["id"]); ?>" class="pull-right text-success tooltip-title" data-toggle="tooltip" data-placement="left" title="点击查看记录详情">
                        <i class="fa fa-info-circle"></i>
                      </a>
                    </h4>
                    
                    <p><?php echo ($point["type"]); ?></p>
                    <p><?php echo ($point["createdate"]); ?></p>
                    <p><?php echo ((isset($point["store_name"]) && ($point["store_name"] !== ""))?($point["store_name"]):'无门店信息'); ?></p>
                </div><?php endforeach; endif; else: echo "暂无积分记录" ;endif; ?>
            </div>
          </div>
