       ...
       <div class="row">
        ...
        <div class="col-xs-2">
            <div class="text-right">
               <a href="<?php echo U('Admin/add');?>" class="btn btn-sm btn-primary">
                 新增
               </a>
            </div>
        </div>
...
<div class="col-xs-12">
    <div class="animated fadeInUp">
         ...
         <?php if(is_array($adminList)): $i = 0; $__LIST__ = $adminList;if( count($__LIST__)==0 ) : echo "暂无店长信息" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><div class="list-group">
              <div  class="list-group-item title">
                <span class="text-primary">
                  <i class="fa fa-star"></i>
                  <?php echo ($admin["realname"]); ?>
                </span>

                <a href="<?php echo U('Admin/detail');?>?id=<?php echo ($admin["id"]); ?>" 
	...
	<i class="fa fa-external-link"></i>
              ...
              <div class="list-group-item">
                  所属门店：<?php echo ((isset($admin["store_name"]) && ($admin["store_name"] !== ""))?($admin["store_name"]):"未关联"); ?>
              </div>
              <div class="list-group-item">
                  联系电话：<?php echo ($admin["phone"]); ?>
              </div>
            </div><?php endforeach; endif; else: echo "暂无店长信息" ;endif; ?>
    </div>
</div>
