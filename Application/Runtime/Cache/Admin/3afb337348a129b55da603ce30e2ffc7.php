...
<div class="col-xs-12">
    ...
    <i class="fa fa-mail-reply"></i>
            ...
            <div class="panel-body">
                <form data-validation="true" method="POST" action="<?php echo U('Admin/detail');?>">
                    
                    <?php if($error != ''): ?><div class="alert alert-danger">
                            <?php echo ($error); ?>
                        </div><?php endif; ?>

                    <input type="hidden" value="<?php echo ($adminInfo["id"]); ?>" id="id" name="id"/>
