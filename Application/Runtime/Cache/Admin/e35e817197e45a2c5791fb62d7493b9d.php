...
<div class="animated fadeInUp">
    ...
    <i class="fa fa-mail-reply"></i>
        ...
        <div class="panel-body">
             <form data-validation="true" method="POST" action="<?php echo U('Activity/add');?>">
                <?php if($error != ''): ?><div class="alert alert-danger">
                        <?php echo ($error); ?>
                    </div><?php endif; ?>
                <div class="form-group">
                    <label for="">活动名称</label>
                    <input type="text" check-type="required" required-message="请输入活动名称" value="<?php echo ($activityInfo["name"]); ?>" class="form-control" id="name" name="name" placeholder="请输入活动名称...">
                </div>
                <div class="form-group">
