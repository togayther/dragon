		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="text-danger">
					<i class="fa fa-pencil-square-o"></i>&nbsp;积分审核
				</h4>
			</div>
			...
			<table class="table table-bordered table-hover" id="dataTable">
				...
				<tbody>
					<?php if(is_array($auditList)): $i = 0; $__LIST__ = $auditList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$audit): $mod = ($i % 2 );++$i;?><tr>
							<td>
								<a href="<?php echo U('User/detail');?>?id=<?php echo ($audit["userid"]); ?>" class="text-danger tooltip-title" data-toggle="tooltip" data-placement="right" title="点击查看用户详情">
									<?php echo ($audit["user_phone"]); ?>
								</a>
							</td>
							<td><?php echo ($audit["point"]); ?></td>
							<td><?php echo ($audit["type"]); ?></td>
							<td><?php echo ($audit["user_level_name"]); ?></td>
							<td>
								<a href="<?php echo U('Store/detail');?>?id=<?php echo ($audit["store_id"]); ?>" class="text-danger tooltip-title" data-toggle="tooltip" data-placement="right" title="点击查看门店详情">
									<?php echo ($audit["store_name"]); ?>
								</a>
							</td>
							<td><?php echo ($audit["manager_realname"]); ?></td>
							<td><?php echo ($audit["createdate"]); ?>/td>
							<td class="text-center">
								<a href="<?php echo U('Audit/detail');?>?id=<?php echo ($audit["id"]); ?>" class="tooltip-title" data-toggle="tooltip" data-placement="left" title="审核">
