       ...
       <div class="row">
        ...
        <div class="col-xs-2">
            <div class="text-right">
               <a href="<?php echo U('Store/add');?>" class="btn btn-sm btn-primary">
                 新增
               </a>
            </div>
        </div>
...
<div class="col-xs-12">
    <div class="animated fadeInUp">
        <?php if(is_array($storeList)): $i = 0; $__LIST__ = $storeList;if( count($__LIST__)==0 ) : echo "暂无门店信息" ;else: foreach($__LIST__ as $key=>$store): $mod = ($i % 2 );++$i;?><div class="list-group">
              <div  class="list-group-item title">
                ...
                <a href="<?php echo U('Store/detail');?>?id=<?php echo ($store["id"]); ?>" 
	...
	<i class="fa fa-external-link"></i>
              ...
              <div class="list-group-item">
                  所在地址：<?php echo ((isset($store["address"]) && ($store["address"] !== ""))?($store["address"]):'未指定'); ?>
              </div>
              <div class="list-group-item">
                  店长姓名：
                  <?php if($store["admin_id"] != ''): ?><a href="<?php echo U('admin/detail');?>?id=<?php echo ($store["admin_id"]); ?>"  class="text-danger tooltip-title" data-toggle="tooltip" data-placement="right" title="点击查看店长详情"><?php echo ($store["admin_realname"]); ?></a>
                  <?php else: ?>
                    未指定<?php endif; ?>
              </div>
              <div class="list-group-item">
                  店长电话：<?php echo ((isset($store["admin_phone"]) && ($store["admin_phone"] !== ""))?($store["admin_phone"]):'未指定'); ?>
              </div>
            </div><?php endforeach; endif; else: echo "暂无门店信息" ;endif; ?>
    </div>
</div>
